...
<body class="eagle-eye-background">
    <div class="container main-container">
    	...
    	<div class="row">
	    	<div class="col-sm-12">
	    		<form action="<?php echo DIR.'complaint/search'; ?>" role="form" class="eagle-search" method="get">
	    			<div class="form-group">
	    				<input type="text" name="pnumber" id="tags" placeholder="Enter Plate Number" class="form-control" required>
	    			</div>
	    			<div class="form-group">
