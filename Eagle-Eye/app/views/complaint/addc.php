...
top: 5px;}
            ...
            <div class="container main-container">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" role="form" class="eagle-complaint-form form-horizontal">
                            ...
                            <label style="color:#fff">Remain Anonymous</label>
                            <div class="form-group">
                                <input type="radio" name="anonymous" checked="checked" value="yes" class="form-control anon" >
                                <label>Yes</label>
                            </div>
                            <div class="form-group">
                                <input type="radio" name="anonymous" onclick="RedirectMe();" value="no" class="form-control anon" >
                                <label>No</label>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    function RedirectMe(){
        window.location.href="<?php echo DIR.'mydetails/';?>";
    }
</script>
